...
dict_filename = "word_list.csv"
word_filename = "word_list_freq.csv"

# Load the data
# x_train = utils.load_csv(path + "/res/tokens/tokens_clean_original_" + train_filename) # I did not remove the noise
# x_test = utils.load_csv,(path + "/res/tokens/tokens_clean_original_" + test_filename)
x_train = utils.load_csv,(path + "/res/datasets/jiwon/unbiased_tokens_" + train_filename, "tokens")
x_test = utils.load_csv,(path + "/res/datasets/jiwon/unbiased_tokens_" + test_filename, "tokens")

x_train = [t for t in x_train]
x_test = [t for t in x_test]

# Load the labels
y_train = [int(l) for l in utils.load_csv(path + "/res/datasets/jiwon/unbiased_labels_" + train_filename, "label")]
y_test = [int(l) for l in utils.load_csv(path + "/res/datasets/jiwon/unbiased_labels_" + test_filename, "label")]
...
#Todo i DO NOT implement this YET

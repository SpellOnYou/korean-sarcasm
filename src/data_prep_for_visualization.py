...
def prepare_data(shuffle=False, labels_to_categorical=True):
    ...
    # Load the data
    train_data = utils.load_csv(data_path + tokens_filename + train_filename, "tokens")
    test_data = utils.load_csv(data_path + tokens_filename + test_filename, "tokens")
    ...
    # Load the labels
    train_labels = [int(l) for l in utils.load_csv(data_path + labels_filename + train_filename, "label")]
    test_labels = [int(l) for l in utils.load_csv(data_path + labels_filename + train_filename, "label")]
    ...
    tokenizer, train_indices, test_indices = utils.encode_text_as_word_indexes(str(train_data), test_data, lower=False)
